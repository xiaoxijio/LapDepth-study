...
parser.add_argument('--img_dir', type=str, default='example/kitti_demo.jpg')
...
if args.img_dir is not None:
    ...
    result_filelist = ['./example/out_' + args.img_dir.split('/')[-1]]
    ...
    result_folder = './example/out_' + args.img_folder_dir.split('/')[-1]
