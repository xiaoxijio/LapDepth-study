...
def main_worker(gpu, ngpus_per_node, args):
    ...
    val_loader = DataLoader(test_set, batch_size=1, shuffle=(train_sampler is None), num_workers=args.workers,
    ...
    optimizer = torch.optim.AdamW(  # 分布式的这里要改成Model.module.encoder.parameters(),下面也是
